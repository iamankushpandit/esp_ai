...
| **Demo** | /settings: **Run demo** (~50 s, questions drawn at random), **Full demo** (~4 min), **What it gets wrong** (the failure reel). It asks itself in a second voice and answers in its own — hands-free, for filming |
